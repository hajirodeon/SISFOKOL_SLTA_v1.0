...
///nek isih kosong
	if ($totalRows_rsx == 0)
		{?>
		<p>TIDAK ADA SOAL. <a href="soal_pil_soal_add.php?mgkd=<?php echo $_REQUEST['mgkd'];?>&mpelkd=<?php echo $_REQUEST['mpelkd'];?>&pelajaran=<?php echo urlencode(balikin($_REQUEST['pelajaran']));?>&mprogkd=<?php echo $_REQUEST['mprogkd'];?>&progstudi=<?php echo urlencode(balikin($_REQUEST['progstudi']));?>&mkelkd=<?php echo $_REQUEST['mkelkd'];?>&kelas=<?php echo balikin($_REQUEST['kelas']);?>&topikkd=<?php echo $_REQUEST['topikkd'];?>&topik=<?php echo urlencode(balikin($_REQUEST['topik']));?>">Silahkan 
          buat baru!</a> 
          <?
		}	
	...
	?>
        ...
        <p><a href="soal_pil_soal_add.php?mgkd=<?php echo $_REQUEST['mgkd'];?>&mpelkd=<?php echo $_REQUEST['mpelkd'];?>&pelajaran=<?php echo urlencode(balikin($_REQUEST['pelajaran']));?>&mprogkd=<?php echo $_REQUEST['mprogkd'];?>&progstudi=<?php echo urlencode(balikin($_REQUEST['progstudi']));?>&mkelkd=<?php echo $_REQUEST['mkelkd'];?>&kelas=<?php echo balikin($_REQUEST['kelas']);?>&topikkd=<?php echo $_REQUEST['topikkd'];?>&topik=<?php echo urlencode(balikin($_REQUEST['topik']));?>">Buat 
          Baru</a></p>
 ...
 echo $row_rsx['nomer']; ?>
			...
			{ 
				?>
            <option value="soal_pil_soal1.php?mgkd=<?php echo $_REQUEST['mgkd'];?>&mpelkd=<?php echo $_REQUEST['mpelkd'];?>&pelajaran=<?php echo urlencode(balikin($_REQUEST['pelajaran']));?>&mprogkd=<?php echo $_REQUEST['mprogkd'];?>&progstudi=<?php echo urlencode(balikin($_REQUEST['progstudi']));?>&mkelkd=<?php echo $_REQUEST['mkelkd'];?>&kelas=<?php echo balikin($_REQUEST['kelas']);?>&topikkd=<?php echo $_REQUEST['topikkd'];?>&topik=<?php echo urlencode(balikin($_REQUEST['topik']));?>&kd=<?php echo $row_rsx['kd'];?>&nomer=<?php echo $i;?>"><?php echo $i;?></option>
            <?
				} 
...
?>
				...
				if ($row_rspil['status'] == 'true')
					{
					?>
                <strong><a href="soal_pil_soali.php?mgkd=<?php echo $_REQUEST['mgkd'];?>&mpelkd=<?php echo $_REQUEST['mpelkd'];?>&pelajaran=<?php echo urlencode(balikin($_REQUEST['pelajaran']));?>&mprogkd=<?php echo $_REQUEST['mprogkd'];?>&progstudi=<?php echo urlencode(balikin($_REQUEST['progstudi']));?>&mkelkd=<?php echo $_REQUEST['mkelkd'];?>&kelas=<?php echo balikin($_REQUEST['kelas']);?>&topikkd=<?php echo $_REQUEST['topikkd'];?>&topik=<?php echo urlencode(balikin($_REQUEST['topik']));?>&soalkd=<?php echo $row_rsx['kd'];?>&pilkd=<?php echo $row_rspil['kd_pil'];?>"><font color="#FF0000"><?php echo $row_rspil['pil'];?></font></a></strong> 
                <?php
					}
				else
					{
  ...
  ?>
              ...
              <p> [<a href="soal_pil_soal_del.php?mgkd=<?php echo $_REQUEST['mgkd'];?>&mpelkd=<?php echo $_REQUEST['mpelkd'];?>&pelajaran=<?php echo urlencode(balikin($_REQUEST['pelajaran']));?>&mprogkd=<?php echo $_REQUEST['mprogkd'];?>&progstudi=<?php echo urlencode(balikin($_REQUEST['progstudi']));?>&mkelkd=<?php echo $_REQUEST['mkelkd'];?>&kelas=<?php echo balikin($_REQUEST['kelas']);?>&topikkd=<?php echo $_REQUEST['topikkd'];?>&topik=<?php echo urlencode(balikin($_REQUEST['topik']));?>&kd=<?php echo $row_rsx['kd'];?>">HAPUS</a>]</p></td>
          </tr>
