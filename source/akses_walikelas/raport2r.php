...
if ($totalRows_rscek != 0) 
	...
	//auto-kembali
	$returner = "raport1.php?mpkd=$mpkd&progstudi=$progstudi&mkkd=$mkkd&kelas=$kelas&mrkd=$mrkd".
					"&ruang=$ruang&kd=$kd";
	...
	{
	$SQL = sprintf("INSERT INTO siswa_raport_rangking(kd, kd_siswa, kd_tapel, kd_semester, kd_progstudi, ".
