...
?>
			...
			do 
				{  
				?>
            <option value="raport.php?mpkd=<?php echo $row_rsi['mpkd'];?>&progstudi=<?php echo $row_rsi['progstudi'];?>&mkkd=<?php echo $row_rsi['mkkd'];?>&kelas=<?php echo $row_rsi['kelas'];?>&mrkd=<?php echo $row_rsi['mrkd'];?>&ruang=<?php echo $row_rsi['ruang'];?>">Program 
	...
	?>
		...
		?>
          <tr valign="top" bgcolor="<? echo $warna; ?>"> 
            ...
            <td width="306">[<a href="raport1.php?kd=<?php echo $row_rsx['mskd'];?>&mpkd=<?php echo $_REQUEST['mpkd'];?>&progstudi=<?php echo $_REQUEST['progstudi'];?>&mkkd=<?php echo $_REQUEST['mkkd'];?>&kelas=<?php echo $_REQUEST['kelas'];?>&mrkd=<?php echo $_REQUEST['mrkd'];?>&ruang=<?php echo $_REQUEST['ruang'];?>">RAPORT</a>]</td>
          </tr>
