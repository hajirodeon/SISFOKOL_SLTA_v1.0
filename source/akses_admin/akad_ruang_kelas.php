...
<div align="center">
 ...
 echo $row_rs_terjur['progstudi']; ?>
			...
			do 
				{  
				?>
            <option value="akad_ruang_kelas.php?studikod=<? echo $row_rs_progstudi['kd']?>&progstudi=<? echo urlencode($row_rs_progstudi['progstudi']);?>"><? echo $row_rs_progstudi['progstudi'];?></option>
            <?
				} 
        ...
        <p>Kelas : 
          <br><select name="kelas" id="kelas" onChange="MM_jumpMenu('parent',this,0)">
			...
			do 
				{  
				?>
            <option value="akad_ruang_kelas.php?studikod=<? echo $_REQUEST['studikod']; ?>&progstudi=<? echo urlencode($_REQUEST['progstudi']); ?>&kelkod=<? echo $row_rs_kelas['kd'] ?>&kelas=<? echo $row_rs_kelas['kelas'] ?>"><? echo $row_rs_kelas['kelas']?></option>
            <?
				} 
...
$query_rs1 = "SELECT m_kelas.*, m_ruang.*, m_ruang_kelas.*, m_ruang_kelas.kd AS mrkd, m_pegawai.* ".
				...
				"AND m_ruang_kelas.kd_progstudi = '$studikod' ".
	...
	?></p>
		...
		?>
          <tr valign="top" bgcolor="<? echo $warna; ?>"> 
			...
			echo $row_rs1['nama']; 
			?>
              </strong> [<a href="akad_ruang_kelas_del.php?kd=<?php echo $row_rs1['mrkd']; ?>&studikod=<?php echo $_REQUEST['studikod'];?>&progstudi=<?php echo urlencode($_REQUEST['progstudi']);?>&kelkod=<?php echo $_REQUEST['kelkod'];?>&kelas=<?php echo urlencode($_REQUEST['kelas']);?>">HAPUS</a>]</td>
          </tr>
