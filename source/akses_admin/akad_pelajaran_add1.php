...
//cek, sudah ada belum
$SQL1 = sprintf("SELECT * FROM m_pelajaran WHERE kd_progstudi = '$progstudi' ".
					"AND kd_kelas = '$kelas' AND pelajaran = '$pelajaran'");
...
//perintah SQL
$SQL2 = sprintf("INSERT INTO m_pelajaran(kd, kd_progstudi, kd_kelas, pelajaran) ".
					"VALUES ('$x', '$progstudi', '$kelas', '$pelajaran')");
...
$returner = "akad_pelajaran.php?studikod=$studikod&kelkod=$kelkod";
