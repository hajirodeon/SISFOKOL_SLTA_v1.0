        ...
        <p> Program Studi : 
          <br><select name="progstudi" id="progstudi" onChange="MM_jumpMenu('parent',this,0)">
			...
			do 
				{  
				?>
            <option value="akad_pelajaran.php?studikod=<? echo $row_rs_progstudi['kd']?>&progstudi=<? echo urlencode($row_rs_progstudi['progstudi']);?>"><? echo $row_rs_progstudi['progstudi'];?></option>
            <?
				} 
        ...
        <p>Kelas : 
          <br><select name="kelas" id="kelas" onChange="MM_jumpMenu('parent',this,0)">
			...
			do 
				{  
				?>
            <option value="akad_pelajaran.php?studikod=<? echo $_REQUEST['studikod']; ?>&progstudi=<? echo urlencode($_REQUEST['progstudi']); ?>&kelkod=<? echo $row_rs_kelas['kd'] ?>&kelas=<? echo $row_rs_kelas['kelas'] ?>"><? echo $row_rs_kelas['kelas']?></option>
            <?
				} 
...
$query_rs1 = "SELECT * FROM m_pelajaran WHERE kd_progstudi = '$studikod' AND kd_kelas = '$kelkod' ".
	...
	?>
		...
		?>
          <tr valign="top" bgcolor="<? echo $warna; ?>"> 
			...
			?>
              <strong> </strong> [<a href="akad_pelajaran_del.php?kd=<?php echo $row_rs1['kd']; ?>&studikod=<?php echo $row_rs1['kd_progstudi']; ?>&kelkod=<?php echo $row_rs1['kd_kelas']; ?>">HAPUS</a>]</td>
          </tr>
