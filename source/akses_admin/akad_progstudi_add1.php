...
//cek, sudah ada belum
$SQL1 = sprintf("SELECT * FROM m_progstudi WHERE progstudi = '$progstudi'");
...
if ($totalRows_rs1 != 0) 
	{
	$pesan = "Program Studi sudah ada, Silahkan diulangi!";
	$kembali = "akad_progstudi.php";
...
//perintah SQL
$SQL2 = sprintf("INSERT INTO m_progstudi(kd, progstudi) ".
					"VALUES ('$x', '$progstudi')");
...
header("location:akad_progstudi.php");
}
?>