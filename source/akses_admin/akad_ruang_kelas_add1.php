...
//perintah SQL
$SQL2 = sprintf("INSERT INTO m_ruang_kelas(kd, kd_progstudi, kd_kelas, kd_ruang, kd_guru) ".
					"VALUES ('$x', '$progstudi', '$kelas', '$ruang', '$guru')");
...
$returner = "akad_ruang_kelas.php?studikod=$studikod&kelkod=$kelkod";
