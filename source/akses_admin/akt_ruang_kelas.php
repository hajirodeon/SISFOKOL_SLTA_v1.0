      ...
      <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <option selected>
			...
			do 
				{  
				?>
                <option value="akt_ruang_kelas.php?jurikod=<? echo $row_rs_progstudix['kd'] ?>&progstudi=<? echo $row_rs_progstudix['progstudi'] ?>"><? echo $row_rs_progstudix['progstudi']?></option>
                <?
				} 
        ...
        <select name="keli" id="keli" onChange="MM_jumpMenu('parent',this,0)">
          ...
          <option selected>
			...
			do 
				{  
				?>
                <option value="akt_ruang_kelas.php?jurikod=<? echo $_REQUEST['jurikod']; ?>&progstudi=<? echo $_REQUEST['progstudi']; ?>&kelikod=<? echo $row_rs_keli['kd']; ?>&kelas=<? echo $row_rs_keli['kelas']?>"><? echo $row_rs_keli['kelas']?></option>
                <?
				} 
        ...
        <select name="rui" id="rui" onChange="MM_jumpMenu('parent',this,0)">
          ...
          <option selected>
			...
			do 
				{  
				?>
                <option value="akt_ruang_kelas.php?jurikod=<? echo $_REQUEST['jurikod']; ?>&progstudi=<? echo $_REQUEST['progstudi']; ?>&kelikod=<? echo $_REQUEST['kelikod']; ?>&kelas=<? echo $_REQUEST['kelas'];?>&ruikod=<? echo $row_rs_rui['kd']; ?>&ruang=<? echo $row_rs_rui['ruang']?>"><? echo $row_rs_rui['ruang']?></option>
                <?
				} 
